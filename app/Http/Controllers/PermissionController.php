...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('workcenter.permissions.index')->withPermissions($permissions);
    }
    ...
    {
        return view('workcenter.permissions.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('workcenter.permissions.show')->withPermission($permission);
    }
    ...
    {
      $permission = Permission::findOrFail($id);
      return view('workcenter.permissions.edit')->withPermission($permission);
    }
