...
<header class="page-header">
    <div class="container-fluid">
        <h2 class="no-margin-bottom">Add Employee</h2>
    </div>
</header>
...
<div class="row mt-2">
      ...
      <div class="col-lg-12">
        {!! Form::open(array('route' => 'users.store')) !!}
          <div class="row mt-2">
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-header"><strong>Personl Details</strong></div>
                <div class="card-body">
                  {{ Form::hidden('user_id')}}
                  <div class="field">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="field">
                      ...
                      {{-- {{ Form::select('status', ['active','terminated'], null, ['class' => 'form-control', 'required' =>'']) }} --}}
                    ...
                    <div class="field">
                     ...
                     <div class="field">
                         ...
                         <select name="department_id" v-model="department_id" class="form-control">
                            <option value="">- Select -</option>
                            @foreach($departments as $department)
                             <option value="{{$department->id}}" >{{$department->departmentTitle}}</option>
                            @endforeach
                         </select>
                     </div> 
  ...
  @endrole
@role(['employee', 'client', 'supervisor', 'manager'])
