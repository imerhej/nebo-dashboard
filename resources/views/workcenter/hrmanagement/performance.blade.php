...
<header class="page-header">
    ...
    <div class="row bg-white has-shadow mt-2">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <a href="{{route('hrmanagement.createperformance', $employee->id)}}" class="btn btn-primary btn-sm fa fa-plus-circle mt-2 mb-2"> New Review</a>
        </div>
    </div>
                ...
                <table class="table table-sm table-responsive mt-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('hrmanagement.viewperformance', $performance->id)}}" class="btn btn-primary btn-sm fa fa-eye" title="view"></a></td>
                            <td><a href="{{route('hrmanagement.editperformance', $performance->id)}}" class="btn btn-success btn-sm fa fa-pencil" title="edit"></a></td>
                            <td>
                                <form action="{{ route('hrmanagement.performance', $performance->id) }}" method="post" class="performance_delete">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
