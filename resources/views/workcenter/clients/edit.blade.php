...
@section('content')
@role(['superadministrator','adminisrtator', 'office-manager'])
...
<div class="row mt-2">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="field">
                      ...
                      {{ Form::text('firstName', $client->firstName, ['class' => 'form-control', 'required' =>'']) }}
                  </div>
    ...
    @endrole
    @role(['manager','supervisor', 'employee', 'installer', 'client'])
