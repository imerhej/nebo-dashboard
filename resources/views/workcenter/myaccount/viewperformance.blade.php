...
@section('content')
@role(['superadministrator', 'administrator', 'office-manager', 'manager', 'employee', 'supervisor', 'installer'])
...
<header class="page-header">
    ...
    <div class="row bg-white has-shadow mt-2">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <a href="{{route('myaccount.editperformance', $performance->id)}}" class="btn btn-primary btn-sm fa fa-pencil mb-2 mt-2 "> Edit Performance</a>
            </div>
    </div>
